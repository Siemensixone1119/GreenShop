...
export class AuthController {
    ...
    async register(@Body() body: RegisterUserDto,
        ...
        this.setAuthCookie(response, result.accessToken, result.refreshToken, result.sessionId)
    ...
    private setAuthCookie(response: Response, accessToken: string, refreshToken: string, sessionId: number): void {
